...
def park_location_simul():
	actual_loc=system.tag.read('[default]PressIF_TransferCart/TC_AGTC/TransComm/ParkLocation_SMTOPLC').value
	if actual_loc != 0:
		system.tag.write('[default]PressIF_TransferCart/TC_AGTC/TransComm/ActualPosition_PLCTOSM', actual_loc)
